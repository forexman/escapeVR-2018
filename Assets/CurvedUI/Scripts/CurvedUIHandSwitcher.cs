...
#pragma warning restore 0649
        ...
        void SwitchHandTo(GameObject hand)
        {
            LaserBeam.transform.SetParent(hand.transform);
            LaserBeam.transform.ResetTransform();
            LaserBeam.transform.LookAt(LaserBeam.transform.position + hand.transform.forward);
